...
from .. import IGMRF, IGMRF2D, SymIGMRF2D
...
def test_dist_pytree(jax_dist, params):
  ...
  assert_allclose(actual_sample, expected_sample, rtol=3e-4)
  assert_allclose(actual_log_prob, expected_log_prob, rtol=3e-4)
