...
def load_base_patterns(
    ...
    patterns = {
        'household': load_csv_data(
            f'contact_matrices/{prefix}_household_setting_85.csv', header=None).values,
        'school': load_csv_data(
            f'contact_matrices/{prefix}_school_setting_85.csv', header=None).values,
        'work': load_csv_data(
            f'contact_matrices/{prefix}_work_setting_85.csv', header=None).values,
        'community': load_csv_data(
            f'contact_matrices/{prefix}_community_setting_85.csv', header=None).values
    }
