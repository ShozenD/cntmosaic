...
def test_global_prior():
  prior = PenalisedTensorSpline2D(event_dim=1, type='global')
  ...
  # Check the existence and dimension of indices
...
def test_partial_prior():
  prior = PenalisedTensorSpline2D(event_dim=4, type='partial', transform='ilr')
  prior.set_age_bounds(0, 84)
...
def test_full_prior():
  prior = PenalisedTensorSpline2D(event_dim=4, type='full', transform='ilr')
  prior.set_age_bounds(0, 84)
